$(function () {
  ...
  $('.product__slider-carousel').slick({
    slidesToShow: 1,
    dots: true,
    fade: true,
  ...
  $('.product__slider-btn').on('click', function () {
    $('.overlay').removeClass('overlay--active');
    $('.product__slider-popup').removeClass('product__slider-popup--active');
    // $('body').removeClass('lock');
  });
  
  $('.product__item-btn').on('click', function() {
    $('.overlay').addClass('overlay--active');
    $('.product__slider-popup').addClass('product__slider-popup--active');
    // $('body').addClass('lock');
  });
